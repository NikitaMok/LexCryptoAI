...
и маркеров квалификации сделки; автоматическая проверка 21 правила из 32,
...
(BM25 с отсечением окончаний); HTTP-приём контракта и PDF-заключение.

В работе: поиск близких норм по эмбеддингам, семантическое извлечение оговорок,
скоринг адреса контрагента, веб-интерфейс.
