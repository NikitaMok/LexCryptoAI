...
нарушением приводится дословный текст нормы из выверенного корпуса.
...
вида «ст. 1 ч. 7 п. 1» в текст нормы.

В работе: поиск близких норм по эмбеддингам, семантическое извлечение оговорок,
скоринг адреса контрагента, веб-интерфейс и генерация PDF-заключения.
