...
**Поиск близких норм по эмбеддингам.** Chroma поверх того же корпуса нужна там,
где ссылки нет: формулировка в договоре нечёткая, и надо предложить, к какой
норме её подтянуть. Этот слой ещё не реализован и не является условием работы
первого: сначала точная цитата, потом похожие нормы.
...
| Поиск близких норм по эмбеддингам | Не начат |
