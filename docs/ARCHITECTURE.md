...
| Поиск нормы по эмбеддингам | Не начат |
...
Ближайшая задача — скоринг адреса контрагента по открытым данным блокчейна
и поиск близких норм по эмбеддингам там, где лексического совпадения нет.
Семантическое извлечение оговорок — для правил, которые не сводятся
