...
DISCLAIMER = (
    "Заключение носит информационный характер и не является юридической "
    "консультацией. Не заменяет правовую экспертизу юриста, не гарантирует "
    "принятие контракта банком и не освобождает от самостоятельной проверки "
    "актуальности норм на момент сделки. Проверка не является цифровым анализом "
    "в смысле статьи 35 Федерального закона от 04.08.2026 № 282-ФЗ."
)
FOOTER = (
    "Информационный характер. Не юридическая консультация. "
    "Не цифровой анализ по ст. 35 № 282-ФЗ."
)
